                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              CommonText(
                                                text:
                                                    '${AppString.bookingid} ${controller.bookingId.value}',
                                                fontSize: 12.sp,
                                                color: AppColors.black300,
                                                fontWeight: FontWeight.w400,
                                              ),
                            ...
                            children: [
                                  ...
                                  onTap: () async {
                                    ...
                                    Get.dialog(
                                      AlertDialog(
                                        ...
                                        content: CommonText(
                                          maxLines: 4,
                                          text: AppString.cancleBookingSure,
                                          fontSize: 14.sp,
                                          fontWeight: FontWeight.w400,
                                        ),
                                        actions: [
                              ...
                              Expanded(
                                child: CustomButton(
                                  ...
                                  onTap: () async {
                                    print(
                                      "Chat id : 😍😍😍😍 ${controller.chatId}",
                                    );
                                    Get.toNamed(
                                      AppRoutes.message,
                                      parameters: {"id": controller.chatId},
                                      arguments: {
    ...
    return Row(
      ...
      children: [
        ...
        CommonText(
          ...
          fontSize: 13.sp,
          color:
              valueColor ?? (isBold ? AppColors.black500 : AppColors.black400),
          fontWeight: isBold ? FontWeight.w600 : FontWeight.w400,
        ),
      ],
    );
